						...
						<div class="accordion-item <?php echo $status; ?>" id="subs-<?php echo $subscription->id; ?>">
							...
							<div id="subs-<?php echo $subscription->id; ?>-dropdown" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
								<div class="accordion-body">
									...
									<p><small><strong><?php _e('Status', 'doenanova'); ?></strong>: <span class="<?php echo $badge; ?> tag"><i class="fas fa-xs fa-<?php echo $icon; ?>"></i> <?php _e('Active', 'doenanova'); ?></span></small></p>
									<br />
			...
			<?php if (!empty($subscriptions->data)) {
				if ($subscriptions->has_more) { ?>
					...
					<div id="loadmore_recurring_donations-btn_container">
						...
						<!-- Fail message -->
						<div id="loadmore_recurring_donations-fail-message" class="notification is-danger loadmore_recurring_donations-message"><?php _e('Recurring donations could not be loaded.', 'doenanova'); ?></div>
