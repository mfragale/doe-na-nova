			...
			<p>
				<small>
					...
					<?php if ($customer_source) {
						$card = $customer->sources->retrieve($customer_source); ?>
						<span class="tag is-success"><i class="fa-brands fa-cc-<?php echo strtolower($card->brand); ?>"></i> <span><?php echo $card->last4; ?></span></span>
					<?php } else { ?>
